    ...
    <div id="header">
        ...
        <ul class="menu">
            ...
            <li><a href="AdminParticularSearch.jsp">Videos</a></li>
          	<li><a href="servUsers">Users detail</a></li>
            </ul>
            </li>
            ...
            <li><a href='<c:url value="#"></c:url>'>Process</a>
                ...
                <ul>
                   ...
                   <li><a href="AdminRename.jsp">Rename</a></li>
...
Email_Id:<%=session.getAttribute("Email") %>
    ...
    <div id="middle">
        ...
        <div id="container">
			...
			<form action="newUpload" method="post" ENCTYPE="multipart/form-data" style="
...
Choose File:   <input type="File" name="file" style="width:300px"/>
