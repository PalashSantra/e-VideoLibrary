        ...
        <ul class="menu">
            ...
            <li><a href='<c:url value="#"></c:url>'>Process</a>
                ...
                <ul>
                   ...
                   <li><a href='<c:url value="#"></c:url>'>Rename</a></li>
...
Email_Id:<%=session.getAttribute("Email") %>
    ...
    <div id="middle">
        ...
        <div id="container">
            <div id="regcontent">
			<div class="regishead">
                <p>Update A file Here...</p>
                </div>




<form action="servModification" method="post" style="
...
Old Name:   <input type="text" name="Ofilename" value="<%if(request.getParameter("oldfile")!=null){out.println(request.getParameter("oldfile"));} %>"/>
			
New Name :  <input type="text" name="Nfilename" />
