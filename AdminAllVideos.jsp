...
Email_Id:<%=session.getAttribute("Email") %>
    ...
    <div id="middle">
        ...
        <div id="container">
            <div id="content">
                <form action="servAdminParticularSearch" method="get">
                <pre>
    ...
    <table>
		<tr>
			...
			<tr>
				<td><a href='<c:url value="servDownloadVideo"><c:param name="n2" value="${row.sFileName}"/></c:url>'>${row.sFileName}</a></td>
				<td>${VF.ProperQuantity(row.lSizeByte)}</td>
				<td><a href='<c:url value="servPlayVideo"><c:param name="n1" value="${row.sFileName}"/></c:url>'>Play</a></td>
				<td><a href='<c:url value="servDownloadVideo"><c:param name="n2" value="${row.sFileName}"/></c:url>'>Download</a></td>
				
				<td><a href='<c:url value="servDelete"><c:param name="n3" value="${row.sFileName}"/></c:url>'>Delete</a></td>
				<td><a href='<c:url value="AdminRename.jsp"><c:param name="oldfile" value="${row.sFileName}"/></c:url>'>Update</a></td>
			</tr>
			</c:forEach>
