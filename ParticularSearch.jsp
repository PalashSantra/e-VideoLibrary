...
<c:choose>
    ...
    <table>
		...
		<c:forEach var="row" items="${Video}">
			<tr>
				<td><a href='<c:url value="http://localhost/VideoDirectory/servPlayVideo"><c:param name="n1" value="${row.sFileName}"/></c:url>'>${row.sFileName}</a></td>
				<td>${VF.ProperQuantity(row.lSizeByte)}</td>
				
				<td><a href='<c:url value="http://localhost/VideoDirectory/servPlayVideo"><c:param name="n1" value="${row.sFileName}"/></c:url>'>PLay</a></td>
				<td><a href='<c:url value="http://localhost/VideoDirectory/servPlayVideo"><c:param name="n1" value="${row.sFileName}"/></c:url>'>Download</a></td>
			</tr>
		</c:forEach>
	</table>
	</div>
