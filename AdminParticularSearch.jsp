...
<c:choose>
    ...
    <table>
		...
		<c:forEach var="row" items="${Video}">
			<tr>
				<td><a href='<c:url value="servPlayVideo"><c:param name="n1" value="${row.sFileName}"/></c:url>'>${row.sFileName}</a></td>
				...
				<td><a href='<c:url value="servPlayVideo"><c:param name="n1" value="${row.sFileName}"/></c:url>'>Download</a></td>
